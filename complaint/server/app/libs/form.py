...
output_data = {
    ...
    "2": "(고소 취지를 적어야해. 죄명 및 피고소인에 대한 처벌 의사를 포함해야해. 형식은 '고소인은 피고소인을 ~~죄로 고소하오니 처벌하여 주시기 바랍니다.'이거야.)",
    "3": "(범죄 사실을 적어야해. 범죄사실은 형법 등 처벌법규에 해당하는 사실에 대하여 일시, 장소, 범행방법, 결과 등을 구체적으로 특정하여 기재해야 하며, 고소인이 알고 있는 지식과 경험, 증거에 의해 사실로 인정되는 내용을 기재해줘.\
    ...
    "4": "(고소 이유를 적어야해. 고소이유에는 피고소인의 범행 경위 및 정황, 고소를 하게 된 동기와 사유 등 범죄사실을 뒷받침하는 내용을 간략, 명료하게 기재해야 해. 그리고 합의 여부, 처벌 의사에 따라 '범죄사실과 같이 피고소인은 사기범행을 \
                    하였습니다. 피고소인과는 합의하지 않았으며/합의하였으며, 피고소인의 처벌을 원합니다/원하지 않습니다'의 문장이 포함되어 있어야해.)",
    "5": "(증거자료를 적어야해. 없으면 공백으로 놓으면 돼)",

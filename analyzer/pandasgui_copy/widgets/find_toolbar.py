...
class FindToolbar(QtWidgets.QToolBar):
    def __init__(self, parent=None):
        ...
        self.image_folder = os.path.join(os.path.dirname(__file__), '..', 'resources', 'images')
        ...
        match_case_icon_path = os.path.join(self.image_folder, "case-sensitive.svg")
        ...
        regex_icon_path = os.path.join(self.image_folder, "regex.svg")
        ...
        match_exactly_icon_path = os.path.join(self.image_folder, "match-exactly.svg")
        ...
        up_arrow_icon_path = os.path.join(self.image_folder, "arrow-up.svg")
        ...
        down_arrow_icon_path = os.path.join(self.image_folder, "arrow-down.svg")
        ...
        cancel_icon_path = os.path.join(self.image_folder, "close.svg")

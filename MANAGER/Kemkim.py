...
class KimKem:
    ...
    def cal_tf(self, keyword_list, period_divided_dic_merged):
        ...
        # tqdm을 사용하여 진행 바 추가
        for key, value in tqdm(period_divided_dic_merged.items(), desc="TF 계산 ", file=sys.stdout):
            keyword_counts = {}
    ...
    def cal_df(self, keyword_list, period_divided_dic):
        ...
        for period in tqdm(period_divided_dic, desc="DF 계산 ", file=sys.stdout):
            keyword_counts = {}
    ...
    def cal_DoV(self, keyword_list, period_divided_dic, tf_counts, trace=True):
        DoV_dict = {}
        for period in tqdm(period_divided_dic, desc="DOV 계산 ", file=sys.stdout):
            keyword_DoV_dic = {}
    ...
    def cal_DoD(self, keyword_list, period_divided_dic, df_counts, trace=True):
        DoD_dict = {}
        for period in tqdm(period_divided_dic, desc="DOD 계산 ", file=sys.stdout):
            keyword_DoV_dic = {}

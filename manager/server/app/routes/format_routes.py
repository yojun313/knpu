...
def download_engkor_list():
    ...
    return FileResponse(file_path, media_type="text/csv", filename="engkor_list.csv")


@router.get("/exception")
def download_exception_list():
    file_path = os.path.join(DATA_DIR, "exception_list.csv")
    return FileResponse(file_path, media_type="text/csv", filename="exception_list.csv")


@router.get("/tokenize")
def download_tokenize_list():
    file_path = os.path.join(DATA_DIR, "tokenize_list.csv")
    return FileResponse(file_path, media_type="text/csv", filename="tokenize_list.csv")

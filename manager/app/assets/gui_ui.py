...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab_userlist.setObjectName("tab_userlist")
        ...
        self.userName_lineinput.setObjectName("userName_lineinput")
        ...
        self.user_email_lineinput.setObjectName("user_email_lineinput")
        ...
        self.user_key_lineinput.setObjectName("user_key_lineinput")
        ...
        self.user_deleteuser_button.setObjectName("user_deleteuser_button")

        self.horizontalLayout.addWidget(self.user_deleteuser_button)

        self.user_adduser_button = QPushButton(self.tab_userlist)
        self.user_adduser_button.setObjectName("user_adduser_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_email.setText(
            QCoreApplication.translate("MainWindow", "\uc774\uba54\uc77c:", None)
        )
        self.label_key.setText(QCoreApplication.translate("MainWindow", "Key:", None))
        self.user_deleteuser_button.setText(
            QCoreApplication.translate(
                "MainWindow", "\uc0ac\uc6a9\uc790 \uc0ad\uc81c", None
            )
        )
        self.user_adduser_button.setText(
            QCoreApplication.translate(
                "MainWindow", "\uc0ac\uc6a9\uc790 \ucd94\uac00", None
            )
        )
        self.tabWidget_user.setTabText(
            self.tabWidget_user.indexOf(self.tab_userlist),
            QCoreApplication.translate(
                "MainWindow", "\uc0ac\uc6a9\uc790 \ubaa9\ub85d", None
            ),
        )
